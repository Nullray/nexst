...
#        [get_bd_pins mem_axi_id_remover/aresetn]
    ...
    set const_14b0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 const_14b0 ]
    set_property -dict [list CONFIG.CONST_WIDTH {14} CONFIG.CONST_VAL {0x0} ] $const_14b0
    ...
    foreach pair ${pair_list} {
        ...
        set_property -dict [list CONFIG.DIN_WIDTH {48} CONFIG.DIN_FROM {33} CONFIG.DIN_TO {0}] $slice
        ...
        connect_bd_net [get_bd_pins const_14b0/dout] [get_bd_pins ${concat}/In1]
